...
export const DEMO_USERS: Record<string, DemoUser> = {
  admin: {
    ...
    profile: { firstName: 'Anna', lastName: 'Garcia' },
  },
  teacher: {
    id: 'demo-teacher',
    ...
    profile: { firstName: 'Laura', lastName: 'Fernandez' },
  },
  student: {
    id: 'demo-student',
    ...
    profile: { firstName: 'Maria', lastName: 'Garcia' },
  },
  parent: {
    id: 'demo-parent',
    ...
    profile: { firstName: 'Carlos', lastName: 'Ruiz' },
  },
};
